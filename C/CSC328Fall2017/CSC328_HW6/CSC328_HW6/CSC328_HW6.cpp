...
void RenderScene(void) {
	...
	float ambientLight[] = { 0.0, 1.0, 0.0, 0.5 }; //strong green ambient light
	float diffuseLight[] = { 0.0, 1.0, 0.0, 0.5 }; //reflective lighting
	float specularLight[] = { 0.0, 1.0, 0.0, 0.5 };	//specular
