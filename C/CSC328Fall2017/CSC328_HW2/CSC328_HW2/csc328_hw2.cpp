...
boolean walkPolyman = true, walkPolywoman = true; //determines whether walk animation on feet are on or off
...
int main(int argc, char* *argv) {
	//window header name
	char header[] = "Homework 2: Polyman and Polywoman Cutscene by Russell Ferguson";
