...
class Bricks extends Solids{ //Done
	//Technically the term is "cuboid"
	//length, height, width
	...
	@Override
	public void printSolid() {
		System.out.printf("Cuboid:\t\tLength: \t%3d\tHeight:%3d\tWidth:%3d\t\tVolume: %3.4f  \tSurface Area: %3.4f\n", len, hig, wid, volume, area);
	}
	@Override
	public void printVolArea(){
		System.out.printf("Cuboid:\t\tVolume: %3.4f  \tSurface Area: %3.4f\n", volume, area);
	}
}
